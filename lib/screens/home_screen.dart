          ...
          child: Column(
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  _moodButton('Happy', 'assets/images/happy.png', Color(0xFFEF5DA8)),
                  _moodButton('Calm', 'assets/images/calm.png', Color(0xFFAEAFF7)),
                  _moodButton('Relax', 'assets/images/relax.png', Color(0xFFF09E54)),
                  _moodButton('Focus', 'assets/images/focus.png', Color(0xFFA0E3E2)),
                ],
              ),
              ...
              Expanded(
                child: ListView(
                  children: [
                    _taskCard('Peer Group Meetup', 'Let’s open up to the thing that matters among the people', Icons.people, Colors.pink.shade100),
                    _taskCard('Listen to some music', 'Heal your mind with our stunning healing tracks and songs', Icons.music_note, Colors.orange.shade100),
                  ],
                ),
              ),
            ],
        ...
        children: [
          Expanded(
            child: Container(
              ...
              child: const Text('Hello, Sarina!\nLet’s Chat', style: TextStyle(fontWeight: FontWeight.bold)),
            ),
          ),
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                const SizedBox(height: 5),
                Text('Join Now →', style: TextStyle(color: Colors.pink.shade700, fontWeight: FontWeight.bold)),
              ],
            ),
          ),
        ],
